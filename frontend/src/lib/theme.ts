...
// CareConnect Theme Colors
const PRIMARY = "#840132";
const PRIMARY_LIGHT = "#a8013d";
const PRIMARY_DARK = "#5e0124";
const SECONDARY = "#005A43";
const BLACK = "#000000";
  ...
  components: {
    ...
    MuiButton: {
      styleOverrides: {
        ...
        containedSecondary: {
          background: `linear-gradient(135deg, ${SECONDARY} 0%, #003d2e 100%)`,
          "&:hover": {
            background: `linear-gradient(135deg, #007a5e 0%, ${SECONDARY} 100%)`,
          },
        },
        outlined: {
          borderWidth: "2px",
