...
from app.api.v1 import admin, appointments, auth, email, files, handover, health, labs, metrics, providers, rag, test_results, voice, whatsapp
...
app.include_router(test_results.router, prefix="/api/v1/test-results", tags=["Test Results"])
